...
public class DoubleAssociation extends Relation{

	
	private boolean drawSecondArrow = false;
	
	public DoubleAssociation(Class father, Class son, String name, String cardFather, String cardSon) {
	...
	public PolygonDecoration myPolygonDecoration(){
		...
		pl.addPoint(-2, -2);
		if (drawSecondArrow){
			PolygonDecoration deco2 = new PolygonDecoration();
			deco2.setTemplate(pl);
			return deco2;
		}			
		else {
			PolygonDecoration deco = new PolygonDecoration();
			deco.setTemplate( pl );
			drawSecondArrow = true;
			return deco;
		}
	}
